    ...
    <div style={modalStyle} className={classes.paper}>
      ...
      <div className='w-full mt-7 text-center text-md  '>
        ...
        Happy to connect and talk more!
         ...
         <AlternateEmailIcon fontSize='default' className='' />: <a href="mailto:" className=''>Email</a> 
         </div>
         <div className='pt-3 w-full text-center'>

         <LinkedInIcon fontSize='default' className=''/> <a className='' href='https://www.linkedin.com/in/jose-collado/' target='_blank'>linkedin.com/in/jose-collado</a>
         </div>
      </div>
      <div className='p-10 flex flex-col space-y-4 w-full place-content-center p-3 '>
      <TextField onChange={handleNameValue} id="outlined-size-small 1" label="Name" variant="outlined" className='w-56'/>
      <TextField onChange={handleEmailValue} id="outlined-size-small 2" label="E-mail" variant="outlined" className='w-64' />
      <TextField
