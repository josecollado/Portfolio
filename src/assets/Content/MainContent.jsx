...
const MainContent = ({messageSent, handleMessage}) => {
  ...
  return (
    <div className=' max-h-screen'>
      <div className='html-tag pl-5 animate lg:mt-8 md:mt-16 '>{`<html>`}</div>
      <div className=' html-tag pl-8 top-0  animate '>{`<body>`}</div>

      
        <div className='html-tag h1-tag mt-5 sm:mt-36 md:mt-16 pl-6 animate xl:mt-24 '>{`<h1>`}</div>
        ...
        <div className=' pl-24 html-tag animate btn md:mb-20  xl:mb-3'>{`</button>`}</div>
      

      <div className=' m-auto html-tag pb-3  pl-8 animate lg:mt-10'>{`</body>`}</div>
